<?php
/**
 * odeh-web-programming functions and definitions
 *
...
function odeh_web_programming_setup() {
	 ...
	 * If you're building a theme based on odeh-web-programming, use a find and replace
	 * to change 'odeh-web-programming' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'odeh-web-programming', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'odeh-web-programming' ),
	) );
...
function odeh_web_programming_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'odeh-web-programming' ),
		'id'            => 'sidebar-1',
		'description'   => '',
